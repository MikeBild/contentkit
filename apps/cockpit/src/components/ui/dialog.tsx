 ...
 *
 * Four local deviations from what `shadcn add dialog` writes, all deliberate:
 *
 ...
 *  4. **A default `onCloseAutoFocus` that puts focus back on the opener.** Radix
 ...
 *
 * `shadcn add dialog` would revert all four.
 */
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ...
        /**
         * Put focus back on the control that opened this — the fourth
