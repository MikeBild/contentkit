      ...
      schemas: {
        ...
        SemanticDocument: {
          ...
          properties: {
            ...
            summary: { type: 'string' },
            locale: { type: 'string' },
            nodes: { type: 'array', minItems: 1, items: { $ref: '#/components/schemas/SemanticNode' } },
          },
        },
        PatternCandidate: {
          type: 'object',
        ...
        PatternDescriptor: {
          ...
          properties: {
            ...
            rendering_strategy: {
              type: 'object',
              required: ['primary_output', 'alternatives', 'png_role', 'rationale'],
              properties: {
