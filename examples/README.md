...
| `pattern-gallery/` | complete publishing review, responsive SVG/PNG gallery, validation reports, and screenshots | generated |
...
resolution. The same command measures all 972 SVGs and 1,097 semantic HTML cases
...
or machine-readable selection guide fail validation. Pattern previews use the
validated SVG baseline and its derived PNG export.
